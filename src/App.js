...
class App extends React.Component {
    ...
    SelectMusic = () => {
        this.setState({
            ...
            this.aud = document.querySelector('audio');
            // changes the source of the audio element to source of selected song
    ...
    PlayNext = () => {
        ...
        this.setState({
            ...
            this.aud = document.querySelector('audio');
            // changes the source of the audio element to source of next song
            this.aud.src = process.env.PUBLIC_URL + '/Audios/' + this.state.song +'.mp3';
            this.TogglePlayPauseMusic();
        })
    }
    ...
    PlayPrevious = () => {
        ...
        this.setState({
            ...
            this.aud = document.querySelector('audio');
            // changes the source of the audio element to source of previous song
            this.aud.src = process.env.PUBLIC_URL + '/Audios/' + this.state.song +'.mp3';
            this.TogglePlayPauseMusic();
        })
    }
